...
public class AttributeDefaultValueChangeReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Attribute, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public AttributeDefaultValueChangeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.iC_ReactToAttributeChanges.AttributeDefaultValueChangeReaction.ActionUserExecution userExecution = new mir.reactions.iC_ReactToAttributeChanges.AttributeDefaultValueChangeReaction.ActionUserExecution(this.executionState, this);
