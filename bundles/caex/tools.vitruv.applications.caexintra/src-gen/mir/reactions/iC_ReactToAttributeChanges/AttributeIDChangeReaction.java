...
public class AttributeIDChangeReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Attribute, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public AttributeIDChangeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.iC_ReactToAttributeChanges.AttributeIDChangeReaction.ActionUserExecution userExecution = new mir.reactions.iC_ReactToAttributeChanges.AttributeIDChangeReaction.ActionUserExecution(this.executionState, this);
