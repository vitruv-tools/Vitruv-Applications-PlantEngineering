...
public class AttributeDataTypeChangeReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEAttribute<Attribute, String> replaceChange;
  
  private int currentlyMatchedChange;
  
  public AttributeDataTypeChangeReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.iC_ReactToAttributeChanges.AttributeDataTypeChangeReaction.ActionUserExecution userExecution = new mir.reactions.iC_ReactToAttributeChanges.AttributeDataTypeChangeReaction.ActionUserExecution(this.executionState, this);
