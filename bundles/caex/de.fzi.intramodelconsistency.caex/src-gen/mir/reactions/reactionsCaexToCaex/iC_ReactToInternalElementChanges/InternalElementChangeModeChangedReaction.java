...
class InternalElementChangeModeChangedReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsCaexToCaex.iC_ReactToInternalElementChanges.InternalElementChangeModeChangedReaction.ActionUserExecution userExecution = new mir.reactions.reactionsCaexToCaex.iC_ReactToInternalElementChanges.InternalElementChangeModeChangedReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean matchReplaceChange(final EChange change) {
    if (change instanceof ReplaceSingleValuedEAttribute<?, ?>) {
    	ReplaceSingleValuedEAttribute<CAEX.InternalElement, CAEX.ChangeMode> _localTypedChange = (ReplaceSingleValuedEAttribute<CAEX.InternalElement, CAEX.ChangeMode>) change;
    	...
    	this.replaceChange = (ReplaceSingleValuedEAttribute<CAEX.InternalElement, CAEX.ChangeMode>) change;
    	return true;
    }
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InternalElement affectedEObject, final EAttribute affectedFeature, final ChangeMode oldValue, final ChangeMode newValue, @Extension final RoutinesFacade _routinesFacade) {
    }
  }
}
