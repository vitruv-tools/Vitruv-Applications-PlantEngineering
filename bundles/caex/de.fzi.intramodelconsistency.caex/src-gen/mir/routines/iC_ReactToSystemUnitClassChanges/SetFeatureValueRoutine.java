...
public class SetFeatureValueRoutine extends AbstractRepairRoutineRealization {
  ...
  public SetFeatureValueRoutine(final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final EObject e, final EStructuralFeature f, final Object o) {
    super(reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.iC_ReactToSystemUnitClassChanges.SetFeatureValueRoutine.ActionUserExecution(getExecutionState(), this);
